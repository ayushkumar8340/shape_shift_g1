...
from envs.base.base_env_config import (  # noqa:F401
    BaseAgentCfg,
    BaseEnvCfg,
    BaseSceneCfg,
    DomainRandCfg,
...
@configclass
class G1CrouchFlatEnvCfg(BaseEnvCfg):
    reward = G1CrouchWalkingRewardCfg()
    ...
    def __post_init__(self):
        ...
        self.commands.ranges.base_height = (0.60 * H0, 1 * H0)


@configclass
class G1CrouchFlatAgentCfg(BaseAgentCfg):
    experiment_name: str = "g1_crouch_flat"
    wandb_project: str = "g1_crouch_flat"


@configclass
class G1CrouchRoughEnvCfg(G1CrouchFlatEnvCfg):
...
@configclass
class G1CrouchRoughAgentCfg(BaseAgentCfg):
    experiment_name: str = "g1_crouch_rough"
    wandb_project: str = "g1_crouch_rough"
